...
object Slf4jLogger {
  ...
  private class IntermediateForConcretes[F[_]: Applicative] extends SelfAwareStructuredLogger[F]{
  ...
  private class Slf4JLogger[F[_]: Sync](val logger: JLogger) extends IntermediateForConcretes[F] {
